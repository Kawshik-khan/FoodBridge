  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute top-1/4 left-1/4 h-[400px] w-[400px] rounded-full bg-primary/30 blur-[120px]" />
        <div className="absolute bottom-1/4 right-1/4 h-[300px] w-[300px] rounded-full bg-secondary/20 blur-[100px]" />
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full p-12">
          <div className="glass-card rounded-3xl p-8 max-w-md text-center">
            ...
            <p className="text-muted-foreground">
              Join thousands of donors and receivers working together to reduce food waste and fight hunger in our communities.
            </p>
          </div>
